...
houses.push(new GetHouse(" يَكفِيهِ مِن لَوعَةِ التَشتِيتِ أَنَّ لَهُ,مِنَ النَوى كُلَّ يَومٍ ما يُروعُهُ", [
    ...
    ويضاف عليها بعده عم محبوبته وما كان هذا إلا ليزيده هما`, "مخاوف البعد والتشتت من الغربة", "../../assets/img/house2.jpg"));
...
houses.push(new GetHouse(" تأبى المطامعُ إلا أن تُجَشّمه,للرزق كداً وكم ممن يودعُهُ", [
    ...
    ["تثقله", "تعبا"],
     ...
     على هذا الرزق`, "سعي الشاعر الدائم بطلب الرزق", "../../assets/img/house4.jpg"));
...
houses.push(new GetHouse(" وَدَّعتُهُ وَبوُدّى لَو يُوَدِّعُنِي,بصَفوَ الحَياةِ وَأَنّى لا أَودعُهُ", [
    ...
    .ولا أودع زوجتي ولا أصل إلى لحظة الوداع الأليمة هذه`, "تمني الشاعر عدم الفراق", "../../assets/img/house6.jpg"));
houses.push(new GetHouse(" وَكَم تَشبَّثَ بى يَومَ الرَحيلِ ضُحَىً,وَأَدمُعِى مُستَهِلّاتٍ وَأَدمُعُهُ", [
    ...
    والدموع تسيل من عينيها وعيناه`, "تعلق الشاعر الشديد بزوجته", "../../assets/img/house7.jpg"));
