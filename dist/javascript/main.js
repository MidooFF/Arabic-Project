...
houses.push(new GetHouse(" يَكفِيهِ مِن لَوعَةِ التَشتِيتِ أَنَّ لَهُ,مِنَ النَوى كُلَّ يَومٍ ما يُروعُهُ", [
...
houses.push(new GetHouse(" كَأَنَّما هُوَ فِى حِلِّ وَمُرتحلٍ,ممُوَكَّلٍ بِفَضاءِ اللَهِ يَذرَعُهُ", [
...
houses.push(new GetHouse(" تأبى المطامعُ إلا أن تُجَشّمه,للرزق كداً وكم ممن يودعُهُ", [
    ["تُجَشّمه", "كداً"],
    ["تثقله", "تعبا"],
], `تفرض عليه حاجاته ورغباته أن يتكلف التعب والمشقة وراء سعييه لرغد العيش, 
    فما أكثر من ودعهم من أحبائه`, "سعي الشاعر الدائم بطلب الرزق", "../../assets/img/house4.jpg"));
houses.push(new GetHouse(" اِستَودِعُ اللَهَ فِى بَغدادَ لِى قَمَراً,بِالكَرخِ مِن فَلَكِ الأَزرارَ مَطلَعُهُ", [
    ["بِالكَرخِ", "الأَزرارَ"],
...
houses.push(new GetHouse(" وَدَّعتُهُ وَبوُدّى لَو يُوَدِّعُنِي,بصَفوَ الحَياةِ وَأَنّى لا أَودعُهُ", [
    ["بصَفوَ", "أَودعُهُ"],
    ["رغد", "أفارقه"],
...
houses.push(new GetHouse(" وَكَم تَشبَّثَ بى يَومَ الرَحيلِ ضُحَىً,وَأَدمُعِى مُستَهِلّاتٍ وَأَدمُعُهُ", [
...
houses.push(new GetHouse(" لا أَكُذب اللَهَ ثوبُ الصَبرِ مُنخَرقٌ,عَنّى بِفُرقَتِهِ لَكِن أَرَقِّعُهُ", [
...
houses.push(new GetHouse(" رُزِقتُ مُلكاً فَلَم أَحسِن سِياسَتَهُ,وَكُلُّ مَن لا يُسُوسُ المُلكَ يَخلَعُهُ", [
...
houses.push(new GetHouse(" بِاللَهِ يا مَنزِلَ العَيشِ الَّذى دَرَست,آثارُهُ وَعَفَت مُذ بِنتُ أَربُعُهُ", [
    ["بِنتُ", "أَربُعُهُ"],
...
houses.push(new GetHouse(" هَل الزَمانُ مَعِيدُ فِيكَ لَذَّتُنا,أَم اللَيالِى الَّتى أَمضَتهُ تُرجِعُهُ", [["تُرجِعُهُ"], ["نعيده"]], `هل من الممكن أن يعود بنا الزمان إلى تلك الأيام الهنيئة التي عشناها فيكي 
    أم أن الليالي قد تعيد إلينا تلك الأيام الهنيئة`, "تمني الشاعر عودة الأيام الجميلة", "../../assets/img/house11.jpg"));
houses.push(new GetHouse(" عِلماً بِأَنَّ اِصطِبارى مُعقِبُ فَرَجاً,فَأَضيَقُ الأَمرِ إِن فَكَّرتَ أَوسَعُهُ", [
    ["اِصطِبارى", "مُعقِبُ"],
...
houses.push(new GetHouse(" عَسى اللَيالى الَّتى أَضنَت بِفُرقَتَنا,جِسمى سَتَجمَعُنِى يَوماً وَتَجمَعُهُ", [["أَضنَت"], ["أضعفت"]], `لعل الأيام التي أضعفت جسدي وأنهكته أن تجمعني يوما مع زوجتي في لقاء قريب `, "أمل الشاعر في لقاء زوجته", "../../assets/img/house13.jpg"));
