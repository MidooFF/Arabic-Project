...
houses.push(
  new GetHouse(
    ...
    ويضاف عليها بعده عم محبوبته وما كان هذا إلا ليزيده هما`,
...
houses.push(
  new GetHouse(
    ...
    `إن مطالب الشاعر ورغباته تدفعه للسعي وراء رزقه لكن قدره يمنعه من الحصول
     على هذا الرزق`,
...
houses.push(
  new GetHouse(
    ...
    `يقول الشاعر في لحظة الفراق ودت لو أنني أفارق رغد الحياة وصفاء الأيام
    .ولا أودع زوجتي ولا أصل إلى لحظة الوداع الأليمة هذه`,
...
houses.push(
  new GetHouse(
    ...
    `يذكر الشاعر شدة تعلق زوجته به يوم مغادرته ترجوه أن لا يسافر ويتركها 
    والدموع تسيل من عينيها وعيناه`,
