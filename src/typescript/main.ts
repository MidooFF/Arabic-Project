...
<h3>13.</h3>
  ...
  if (currentS > 3) {
    ...
    for (let i = 0; i < partOne.length; i++) {
      ...
      if (house.words[0].includes(partOne[i])) {
        span.setAttribute(
          "data-meaning",
          house.words[1][house.words[0].indexOf(partOne[i])]
        );
    ...
    for (let i = 0; i < partTwo.length; i++) {
      ...
      if (house.words[0].includes(partTwo[i])) {
        span.setAttribute(
          "data-meaning",
          house.words[1][house.words[0].indexOf(partTwo[i])]
        );
        span.classList.add("have-meaning");
      }
  ...
  slideTwo.addEventListener("click", function (e: any) {
    if (e.target.getAttribute("data-meaning")) {
      let wordH2 = document.querySelector(
        ".middle .text .word-meaning h2"
      ) as HTMLHeadingElement;
      let meaningP = document.querySelector(
        ".middle .text .word-meaning p"
      ) as HTMLParagraphElement;
      let wordMeaningDiv = document.querySelector(
        ".middle .text .word-meaning"
      ) as HTMLDivElement;
...
houses.push(
  new GetHouse(
    " 1.لا تَعذَلِيه فَإِنَّ العَذلَ يُولِعُه,قَد قَلتِ حَقاً وَلَكِن لَيسَ يَسمَعُهُ",
    [
    ...
    ويعلم أنها تقول الحق لكنه في حالة صراع بين نداء الروح والواقع`,
    "صراع الشاعر الشديد بين روحه والواقع الحر",
    "../../assets/img/house1 (2).jpg"
  )
);

houses.push(
  new GetHouse(
    " 2.يَكفِيهِ مِن لَوعَةِ التَشتِيتِ أَنَّ لَهُ,مِنَ النَوى كُلَّ يَومٍ ما يُروعُهُ",
    [
      ["التَشتِيتِ", "النَوى", "يُروعُهُ"],
      ["ألم الفراق", "البعد", "يخيفه"],
    ],
    `يكفيه من الحزن والهم تلك المخاوف التي يعاني منها أثناء سفره وترحاله
    ويضاف عليها بعده عن محبوبته وما كان هذا إلا ليزيده هما`,
    "مخاوف البعد والتشتت من الغربة",
...
houses.push(
  new GetHouse(
    " 3.كَأَنَّما هُوَ فِى حِلِّ وَمُرتحلٍ,مُوَكَّلٍ بِفَضاءِ اللَهِ يَذرَعُهُ",
    [
      ["حِلِّ", "وَمُرتحلٍ", "يَذرَعُهُ"],
      ["إقامة", "رحيل", "يقيسه بسرعة"],
    ],
    `يبين الشاعر أنه أصبح دائم الترحال لا يستقر في مكان ما وكأنه موكل 
    بقطع بقاع الأرض ذهابا و أيابا على الدوام`,
    "ترحال الشاعر الدائم",
...
houses.push(
  new GetHouse(
    " 4.تأبى المطامعُ إلا أن تُجَشّمه,للرزق كداً وكم ممن يودعُهُ",
    [
      ["تُجَشّمه", "كداً"],
      ["تثقله", "تعبا"],
    ],
    `تفرض عليه حاجاته ورغباته أن يتكلف التعب والمشقة وراء سعييه لرغد العيش, 
    فما أكثر من ودعهم من أحبائه`,
    "سعي الشاعر الدائم لطلب الرزق",
...
houses.push(
  new GetHouse(
    " 5.اِستَودِعُ اللَهَ فِي بَغدادَ لِي قَمَراً,بِالكَرخِ مِن فَلَكِ الأَزرارَ مَطلَعُهُ",
    [
      ["بِالكَرخِ", "الأَزرارَ"],
      ["حي من أياء بغداد", "النجوم"],
    ],
    `لتكن في رعاية الله زوجتي التي تقيم بالكرخ في بغداد وكأن وجهها قمر
    في طلتها يشعشع نورا وسط نجوم السماء التي تزينه`,
    "استوداع المحبوبة برعاية الله في الوطن",
...
houses.push(
  new GetHouse(
    " 6.وَدَّعتُهُ وَبوُدّي لَو يُوَدِّعُنِي,بصَفوَ الحَياةِ وَأَنّي لا أَودعُهُ",
    [
      ["بصَفوَ", "أَودعُهُ"],
      ["رغد", "أفارقه"],
    ],
    `ودت لو أنني في لحظة الفراق أفارق رغد الحياة وصفاء الأيام ولا أودع زوجتي 
    ولا أصل إللى لحظة الوداع الأليمة هذه`,
    "تمني الشاعر عدم الفراق",
...
houses.push(
  new GetHouse(
    " 7.وَكَم تَشبَّثَ بي يَومَ الرَحيلِ ضُحَىً,وَأَدمُعِي مُستَهِلّاتٍ وَأَدمُعُهُ",
    [
...
houses.push(
  new GetHouse(
    " 8.لا أَكُذب اللَهَ ثوبُ الصَبرِ مُنخَرقٌ,عَنّى بِفُرقَتِهِ لَكِن أَرَقِّعُهُ",
    [
      ["مُنخَرقٌ", "أَرَقِّعُهُ"],
      ["مثقوب", "أخيطه"],
    ],
    `أصدق الله تعالى بنفاذ صبري وشدة اشتياقي لزوجتي الحبيبة لكنني أحاول أن 
    ألتزم الصبر و أضبط نفسي `,
    "الصبر ومحاولة ضبط النفس",
...
houses.push(
  new GetHouse(
    "9.رُزِقتُ مُلكاً فَلَم أَحسِن سِياسَتَهُ,وَكُلُّ مَن لا يُسُوسُ المُلكَ يَخلَعُهُ",
    [
...
houses.push(
  new GetHouse(
    " 10.بِاللَهِ يا مَنزِلَ العَيشِ الَّذي دَرَست,آثارُهُ وَعَفَت مُذ بِنتُ أَربُعُهُ",
    [
      ["بِنتُ", "أَربُعُهُ"],
      ["ابتعدت", "المنازل والديار"],
    ],
    `لك الله يا دارا كنا قد أقمنا فيها, والآن قد اندثرت معالمها وانمحت  
    لما غادرتها وابتعدت عنها `,
    "مناشدة الديار التي فارقها الشاعر",
...
houses.push(
  new GetHouse(
    " 11.هَل الزَمانُ مَعِيدُ فِيكَ لَذَّتُنا,أَم اللَيالِي الَّتى أَمضَتهُ تُرجِعُهُ",
    [["تُرجِعُهُ"], ["نعيده"]],
    `هل من الممكن أن يعود بنا الزمان إلى تلك الأيام الهنيئة التي عشناها فيكي 
    أم أن الليالي قد تعيد إلينا تلك الأيام الهنيئة`,
    "تمني الشاعر عودة الأيام الجميلة",
    "../../assets/img/house11.jpg"
  )
);

houses.push(
  new GetHouse(
    " 12.عِلماً بِأَنَّ اِصطِباري مُعقِبُ فَرَجاً,فَأَضيَقُ الأَمرِ إِن فَكَّرتَ أَوسَعُهُ",
    [
      ["اِصطِبارى", "مُعقِبُ"],
      ["الصبر", "متبع, أي تتابع الأشياء"],
    ],
    `و أنا على يقين أن مكافئة صبري وضبط نفسي هي الفرج والسرور فمهما اشتدت 
    وضاقت علي الأمور فإذا ما تأملناها قليلا سنجد لها الحلول`,
    "توقع الشاعر للفرج والأمل",
    "../../assets/img/house12.jpg"
  )
);

houses.push(
  new GetHouse(
    " 13.عَسى اللَيالي الَّتى أَضنَت بِفُرقَتَنا,جِسمي سَتَجمَعُنِي يَوماً وَتَجمَعُهُ",
    [["أَضنَت"], ["أضعفت"]],
    `لعل الأيام التي أضعفت جسدي وأنهكته أن تجمعني يوما مع زوجتي في لقاء قريب `,
    "أمل الشاعر في لقاء زوجته",
    "../../assets/img/house13.jpg"
  )
);
